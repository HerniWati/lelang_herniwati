            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <?php else : ?>
                        ...
                        <a class="btn btn-sm btn-primary mb-2" href="<?= base_url('petugas/databaranglelang/edit/' . $b->id_barang) ?>"><i class="fas fa-edit"></i></a>
                        
                        <a onclick="return confirm('Apakah Anda Yakin Akan Menghapus Barang Ini?')" class=" btn btn-sm btn-danger" href="<?= base_url('petugas/databaranglelang/hapus/' . $b->id_barang) ?>"><i class="fas fa-trash"></i></a>
