        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= base_url('petugas/databaranglelang'); ?>" data-toggle="collapse" data-target="#barang"
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('petugas/datapemenang'); ?>">Pemenang Lelang</a>
                    </div>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <!-- Topbar Search --> 
                <h4 class="font-weight-bold">Sistem</h4>
